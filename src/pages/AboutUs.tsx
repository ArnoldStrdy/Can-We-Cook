...
const AboutUs: React.FC = () => {
  ...
  return (
    <>
      <section id="cs-contact-242" className="py-10 px-5 bg-[#A7ACD9]/20 mt-16">
        <img
          src={BGLogo}
        ...
        <div className="max-w-3xl mx-auto text-center lg:text-left mb-10">
          ...
          <p className="mt-4 text-gray-600 font-semibold">
            At Can We Cook?, we're passionate about helping the Monash
            University community discover the best food spots on and around
            campus. Whether you're looking for a quick bite, hidden gems, or
            honest reviews from fellow students, we've got you covered. Share
            your experiences, explore menus, and connect with the vibrant food
            culture at Monash.
          </p>
        </div>
        ...
        <div className="container mx-auto flex flex-col lg:flex-row gap-10">
          ...
          >
            ...
            <button
              className="w-full bg-[#554971] text-white py-2 rounded hover:bg-[#554971]/90 transition duration-200 hover:cursor-pointer"
              type="submit"
            >
              Submit Message
            </button>
